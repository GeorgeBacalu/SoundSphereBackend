...
namespace SoundSphere.Tests.Mocks
{
    public class RoleMock
    {
        ...
        public static Role GetMockedRole1() => new Role { Id = Guid.Parse("deaf35ba-fe71-4c21-8a3c-d8e5b32a06fe"), Type = RoleType.Admin };
        ...
        public static RoleDto GetMockedRoleDto1() => new RoleDto { Id = Guid.Parse("deaf35ba-fe71-4c21-8a3c-d8e5b32a06fe"), Type = RoleType.Admin };
